...
function choiceShare:onInit()
    ...
    self.pan_circle = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.pan_circle)   -- 提示亲友圈已复制界面
    self.lab_str = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.lab_str)   -- 提示亲友圈已复制界面

    self.btn_xianliao = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.btn_xianliao)
    self.btn_xianliao:addTouchEventListener(handler(self, self.onClickButton))

    self.btn_wechat = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.btn_wechat)
    self.btn_wechat:addTouchEventListener(handler(self, self.onClickButton))

    self.btn_close = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.btn_close)
    self.btn_close:addTouchEventListener(handler(self, self.onClickButton))

    self.btn_wechat2 = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.btn_wechat2)
    self.btn_wechat2:addTouchEventListener(handler(self, self.onClickButton))

    self.btn_xianliao2 = ccui.Helper:seekWidgetByName(self.pan_choice, _Widget.btn_xianliao2)
