...
--        Log.i("添加麻将...."..i)
        ...
        if i % 2 == 1 then 
            myMj:setPosition(cc.p(Define.mj_myCards_position_x-(i/2)*mjBSz.width*scale, Define.mj_myCards_position_y))
            leftMj:setPosition(cc.p(Define.mj_leftCards_position_x,Define.mj_leftCards_position_y+(i/2)*(leftMjSZ.height-12)*scale))
            otherMj:setPosition(cc.p(Define.mj_otherCards_position_x +(i/2)*otherMjSZ.width*scale,Define.mj_otherCards_postion_y))
            rightMj:setPosition(cc.p(Define.mj_rightCards_position_x,Define.mj_rightCards_position_y-(i/2)*(rightMjSZ.height-12)*scale))
            transposition = i+1
        else
            myMj:setPosition(cc.p(Define.mj_myCards_position_x-((i-1)/2)*mjBSz.width*scale, Define.mj_myCards_position_y+9*scale))
            leftMj:setPosition(cc.p(Define.mj_leftCards_position_x,Define.mj_leftCards_position_y+((i-1)/2)*(leftMjSZ.height-12)*scale+15*scale))
            otherMj:setPosition(cc.p(Define.mj_otherCards_position_x+((i-1)/2)*otherMjSZ.width*scale,Define.mj_otherCards_postion_y+10*scale))
            rightMj:setPosition(cc.p(Define.mj_rightCards_position_x,Define.mj_rightCards_position_y-((i-1)/2)*(rightMjSZ.height-12)*scale+15*scale))
            transposition = i-1
        end
        myMj:setScale(scale)
...
--        local label_my = display.newTTFLabel({
--            text = transposition,
--            font = "Arial",
--            size = 30,
...
--            dimensions = cc.size(50, 50)
--        })
--        label_my:setPosition(cc.p(mjBSz.width/2,mjBSz.height/2))
--        label_my:addTo(myMj)


--        local label_left = display.newTTFLabel({
--            text = transposition,
--            font = "Arial",
--            size = 30,
--            color = cc.c3b(255, 0, 0), -- 使用纯红色
...
--            dimensions = cc.size(50, 50)
--        })
--        label_left:setPosition(cc.p(mjBSz.width/2,mjBSz.height/2))
--        label_left:addTo(leftMj)

--        local label_other = display.newTTFLabel({
--            text = transposition,
--            font = "Arial",
--            size = 30,
--            color = cc.c3b(255, 0, 0), -- 使用纯红色
...
--            dimensions = cc.size(50, 50)
--        })
--        label_other:setPosition(cc.p(mjBSz.width/2,mjBSz.height/2))
--        label_other:addTo(otherMj)

--        local label_right = display.newTTFLabel({
--            text = transposition,
--            font = "Arial",
--            size = 30,
--            color = cc.c3b(255, 0, 0), -- 使用纯红色
...
--            dimensions = cc.size(50, 50)
--        })
--        label_right:setPosition(cc.p(mjBSz.width/2,mjBSz.height/2))
--        label_right:addTo(rightMj)
...
function MJTriacks:diceAnimation(pointMin,pointMax, gangAnim)
    CommonSound.playSound("dasezi")
--    MJArmatureCSB.getInstance():setRestoreOriginalTime(Define.shaizi_time)
