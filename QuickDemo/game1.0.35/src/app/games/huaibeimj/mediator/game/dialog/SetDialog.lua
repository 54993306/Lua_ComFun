...
function SetDialog:ctor()
    self.m_pWidget = ccs.GUIReader:getInstance():widgetFromBinaryFile("games/common/mj/setting.csb");
    ...
    --背景音乐设置
    local onImageMusic =  cc.MenuItemImage:create("games/common/mj/common/set/set_switch_on.png", "games/common/mj/common/set/set_switch_on.png")
    local offImageMusic = cc.MenuItemImage:create("games/common/mj/common/set/set_switch_off.png", "games/common/mj/common/set/set_switch_off.png")
    ...
    --音效设置
    local onImageSound =  cc.MenuItemImage:create("games/common/mj/common/set/set_switch_on.png", "games/common/mj/common/set/set_switch_on.png")
    local offImageSound = cc.MenuItemImage:create("games/common/mj/common/set/set_switch_off.png", "games/common/mj/common/set/set_switch_off.png")
    ...
    -- -- 方言开关
    local onImage2 =  cc.MenuItemImage:create("games/common/mj/common/set/set_switch_on.png", "games/common/mj/common/set/set_switch_on.png")
    local offImage2 = cc.MenuItemImage:create("games/common/mj/common/set/set_switch_off.png", "games/common/mj/common/set/set_switch_off.png")
    ...
    -- --出牌开关
    local onImage3 =  cc.MenuItemImage:create("games/common/mj/common/set/set_switch_on.png", "games/common/mj/common/set/set_switch_on.png")
    local offImage3 = cc.MenuItemImage:create("games/common/mj/common/set/set_switch_off.png", "games/common/mj/common/set/set_switch_off.png")   
