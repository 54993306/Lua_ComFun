...
function PaoPeiAnimLayer:ctor()
    ...
    self.winnerSite = MjProxy:getInstance():getPlayerIndexById(MjProxy:getInstance()._gameOverData.winnerId) -- 赢家的位置
...
function PaoPeiAnimLayer:ui_drawActionMj(actionType, mjs, lastPlayerIndex, index)
    ...
    elseif actionType == Define.action_mingGang or actionType == Define.action_anGang or actionType == Define.action_jiaGang then
...
function PaoPeiAnimLayer:ui_drawActionFour(mjs, actionType, lastPlayerIndex, index)
    ...
    elseif actionType == Define.action_mingGang or actionType == Define.action_jiaGang then
        self:ui_drawActionThree(mjs, actionType, lastPlayerIndex, index)
    end
